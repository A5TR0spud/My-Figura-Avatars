...
events.TICK:register(function ()
  ...
  for index, value in ipairs(list) do
    ...
    models.model.HUD:newSprite("s1_".. index)
      :setPos(1, -0.22 * client.getWindowSize().y + 11 - index * 20, 64)
      :setTexture(textures["outline"], 22, 22)
      :setSize(22, 22)
      :setScale(1)
      :setVisible(true)
    models.model.HUD:newSprite("s2_".. index)
      :setPos(0, -0.22 * client.getWindowSize().y + 10 - index * 20, 32)
      :setTexture(textures["back"], 20, 20)
      :setSize(20, 20)
      :setScale(1)
      :setVisible(true)
    models.model.HUD:newBlock("b1_".. index)
      :setPos(-10, -0.22 * client.getWindowSize().y - 8 - index * 20, 0)
      :setBlock(value[1])
      :setScale(0.625)
    ...
    models.model.HUD:newText("t1_".. index)
      :setPos(-22, -0.22 * client.getWindowSize().y + 7 - index * 20, -64)
    ...
    models.model.HUD:newText("t2_".. index)
      :setPos(-180, -0.22 * client.getWindowSize().y + 7 - index * 20, -65)
      :setText(percentText)
      :setScale(1)
      :setBackground(true)
      :setAlignment("RIGHT")
